...
class ApService extends \SoapClient
{
    ...
    private static $classmap = array(
      'CreateMerchantLog' => '\CreateMerchantLog',
      'User' => '\User',
      'MerchantLogCreateRequest' => '\MerchantLogCreateRequest',
      'Invoice' => '\Invoice',
      'UserDefinedField' => '\UserDefinedField',
      'LineItem' => '\LineItem',
      'FinancialCode' => '\FinancialCode',
      'PaymentScheduleItem' => '\PaymentScheduleItem',
      'ElectronicFundsTransferInfo' => '\ElectronicFundsTransferInfo',
      'CheckInfo' => '\CheckInfo',
      'CreateMerchantLogResponse' => '\CreateMerchantLogResponse',
      'MerchantLogCreateResponse' => '\MerchantLogCreateResponse',
      'CardInfo' => '\CardInfo',
      'UpdateMerchantLog' => '\UpdateMerchantLog',
      'MerchantLogUpdateRequest' => '\MerchantLogUpdateRequest',
      'UpdateMerchantLogResponse' => '\UpdateMerchantLogResponse',
      'MerchantLogUpdateResponse' => '\MerchantLogUpdateResponse',
      'RetrieveMerchantLog' => '\RetrieveMerchantLog',
      'MerchantLogRetrieveRequest' => '\MerchantLogRetrieveRequest',
      'RetrieveMerchantLogResponse' => '\RetrieveMerchantLogResponse',
      'MerchantLogRetrieveResponse' => '\MerchantLogRetrieveResponse',
      'MerchantLog' => '\MerchantLog',
      'CancelMerchantLog' => '\CancelMerchantLog',
      'MerchantLogCancelRequest' => '\MerchantLogCancelRequest',
      'CancelMerchantLogResponse' => '\CancelMerchantLogResponse',
      'MerchantLogCancelResponse' => '\MerchantLogCancelResponse',
      'GetRecentAccountActivity' => '\GetRecentAccountActivity',
      'GetRecentAccountActivityRequest' => '\GetRecentAccountActivityRequest',
      'GetRecentAccountActivityResponse' => '\GetRecentAccountActivityResponse',
      'Authorization' => '\Authorization',
      'GetRecentAccountActivityInternational' => '\GetRecentAccountActivityInternational',
      'GetRecentAccountActivityInternationalResponse' => '\GetRecentAccountActivityInternationalResponse',
      'InternationalAuthorization' => '\InternationalAuthorization',
      'CreateMerchant' => '\CreateMerchant',
      'MerchantRequest' => '\MerchantRequest',
      'MerchantPaymentMethodItem' => '\MerchantPaymentMethodItem',
      'PaymentGatewayEnrollment' => '\PaymentGatewayEnrollment',
      'MerchantSettings' => '\MerchantSettings',
      'CreateMerchantResponse' => '\CreateMerchantResponse',
      'MerchantResponse' => '\MerchantResponse',
      'CreateMerchantExtended' => '\CreateMerchantExtended',
      'CreateMerchantExtendedResponse' => '\CreateMerchantExtendedResponse',
      'CreateMerchantResponseWithUniqueId' => '\CreateMerchantResponseWithUniqueId',
      'UpdateMerchant' => '\UpdateMerchant',
      'UpdateMerchantResponse' => '\UpdateMerchantResponse',
      'RetrieveMerchant' => '\RetrieveMerchant',
      'MerchantRetrieveRequest' => '\MerchantRetrieveRequest',
      'RetrieveMerchantResponse' => '\RetrieveMerchantResponse',
      'MerchantRetrieveResponse' => '\MerchantRetrieveResponse',
      'RetrieveMerchantLogHistory' => '\RetrieveMerchantLogHistory',
      'RetrieveMerchantLogHistoryResponse' => '\RetrieveMerchantLogHistoryResponse',
      'MerchantLogHistoryResponse' => '\MerchantLogHistoryResponse',
      'MerchantLogHistory' => '\MerchantLogHistory',
      'QueryMerchantLogs' => '\QueryMerchantLogs',
      'MerchantLogQueryRequest' => '\MerchantLogQueryRequest',
      'QueryMerchantLogsResponse' => '\QueryMerchantLogsResponse',
      'MerchantLogQueryResponse' => '\MerchantLogQueryResponse',
      'GetBackupCards' => '\GetBackupCards',
      'BackupCardOrderRequest' => '\BackupCardOrderRequest',
      'BackupCardOrderBlock' => '\BackupCardOrderBlock',
      'GetBackupCardsResponse' => '\GetBackupCardsResponse',
      'BackupCardResponse' => '\BackupCardResponse',
      'BackupCardInternational' => '\BackupCardInternational',
      'InstantApproval' => '\InstantApproval',
      'InstantApprovalRequest' => '\InstantApprovalRequest',
      'InstantApprovalResponse' => '\InstantApprovalResponse',
      'DeleteInstantApproval' => '\DeleteInstantApproval',
      'DeleteInstantApprovalResponse' => '\DeleteInstantApprovalResponse',
      'DeleteAuthorization' => '\DeleteAuthorization',
      'DeleteAuthorizationRequest' => '\DeleteAuthorizationRequest',
      'DeleteAuthorizationResponse' => '\DeleteAuthorizationResponse',
      'ResendNotification' => '\ResendNotification',
      'ResendNotificationRequest' => '\ResendNotificationRequest',
      'ResendNotificationResponse' => '\ResendNotificationResponse',
      'GetPaymentInformationUrl' => '\GetPaymentInformationUrl',
      'GetPaymentInformationUrlRequest' => '\GetPaymentInformationUrlRequest',
      'GetPaymentInformationUrlResponse' => '\GetPaymentInformationUrlResponse',
      'GetTransactions' => '\GetTransactions',
      'GetTransactionsResponse' => '\GetTransactionsResponse',
      'TransactionsResponse' => '\TransactionsResponse',
      'Transaction' => '\Transaction',
      'GetDisputedTransactions' => '\GetDisputedTransactions',
      'DisputedAccountActivityRequest' => '\DisputedAccountActivityRequest',
      'GetDisputedTransactionsResponse' => '\GetDisputedTransactionsResponse',
      'DisputedTransactionsResponse' => '\DisputedTransactionsResponse',
      'DisputedTransaction' => '\DisputedTransaction',
      'DisputeTransaction' => '\DisputeTransaction',
      'DisputeTransactionRequest' => '\DisputeTransactionRequest',
      'DisputeTransactionResponse' => '\DisputeTransactionResponse',
      'RetrieveSecureCodeAuthPin' => '\RetrieveSecureCodeAuthPin',
      'RetrieveSecureCodeAuthPinRequest' => '\RetrieveSecureCodeAuthPinRequest',
      'RetrieveSecureCodeAuthPinResponse' => '\RetrieveSecureCodeAuthPinResponse',
      ...
      'PaymentScheduleItemResponse' => '\PaymentScheduleItemResponse',
      'GetTransactionsInternational' => '\GetTransactionsInternational',
      'GetTransactionsInternationalResponse' => '\GetTransactionsInternationalResponse',
      'TransactionInternational' => '\TransactionInternational',
      'GetDynamicPaymentMethod' => '\GetDynamicPaymentMethod',
      'GetDynamicPaymentMethodRequest' => '\GetDynamicPaymentMethodRequest',
      'GetDynamicPaymentMethodResponse' => '\GetDynamicPaymentMethodResponse',
      'RetrieveMerchantExtended' => '\RetrieveMerchantExtended',
      'RetrieveMerchantExtendedResponse' => '\RetrieveMerchantExtendedResponse',
      'MerchantRetrieveExtendedResponse' => '\MerchantRetrieveExtendedResponse',
      'MerchantPaymentMethodResponseItem' => '\MerchantPaymentMethodResponseItem');
